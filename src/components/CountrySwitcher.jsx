...
import { Globe, X, Check, MapPin, Plus } from 'lucide-react';
...
export default function CountrySwitcher() {
  ...
  return (
    <>
      ...
      {/* Modal */}
      {isOpen && (
        <div className="fixed inset-0 z-[10000] flex items-start justify-center overflow-y-auto" style={{ padding: '80px 16px 24px 16px' }}>
          {/* Backdrop */}
          <div 
          ...
          <div 
            ref={modalRef}
            className="relative w-full max-w-sm bg-slate-900 border border-slate-700/50 rounded-2xl shadow-2xl shadow-black/50 overflow-hidden my-auto"
          ...
          >
            ...
            {/* Countries List */}
            <div className="p-3 overflow-y-auto" style={{ maxHeight: 'calc(80vh - 140px)' }}>
            ...
            {/* Footer */}
            <div className="p-3 border-t border-slate-700/50 bg-slate-900/95 sticky bottom-0">
